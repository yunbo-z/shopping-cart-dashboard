...
const DashboardModal = () => {
    ...
    return (
        <div className="bg-slate-400/50 absolute top-0 bottom-0 left-0 right-0">
            <div className="bg-white rounded-md shadow-lg w-3/5 h-2/4 p-4 absolute left-1/2 -translate-x-1/2 top-1/2 transform -translate-y-1/2 overflow-auto">
                ...
                <div><DashboardForm></DashboardForm></div>
            </div>
        </div>
    )
}
